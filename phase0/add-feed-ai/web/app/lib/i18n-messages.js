...
export const messages = {
  ...
  "billing": {
    ...
    "chooseStarter": "Choose on Shopify",
    "chooseGrowth": "Choose on Shopify",
    "manageOnShopify": "Manage on Shopify",
    "approveInShopify": "Open Shopify plans",
    "approveHint": "Shopify hosts plan selection and billing. Pick Free, Starter, or Growth there, then return here.",
    "subscribeFailed": "Could not open Shopify plans: {{detail}}",
    "plans": {
      "open": "Upgrade plan",
      "back": "Back",
      "pageTitle": "Choose a plan",
      "pageIntro": "Plans and charges are managed by Shopify App Pricing. Upgrades open Shopify’s plan page.",
      ...
      "onePlanNote": "Shopify allows one active plan per app (not stacked). Changing plans replaces your current plan; Shopify may prorate.",
      "lowerPlanHint": "Lower plans are not a second purchase. Change on Shopify if you want to replace {{plan}} (Shopify may prorate).",
  ...
  "billing": {
    ...
    "chooseStarter": "在 Shopify 选择",
    "chooseGrowth": "在 Shopify 选择",
    "manageOnShopify": "在 Shopify 管理",
    "approveInShopify": "打开 Shopify 套餐页",
    "approveHint": "套餐与扣费由 Shopify 托管。在官方套餐页选择 Free / Starter / Growth，批准后回到本页。",
    "subscribeFailed": "无法打开 Shopify 套餐页：{{detail}}",
    "plans": {
      "open": "升级套餐",
      "back": "返回",
      "pageTitle": "选择套餐",
      "pageIntro": "套餐与收费由 Shopify App Pricing 托管。升级将打开 Shopify 官方套餐页。",
      "howQuota": "配额按「父商品 × 广告平台 × 市场」计（不是按变体）。一件衣服 5 色 × 5 码，Google+美国仍只算 1 次。",
      "onePlanNote": "每个 App 同时只有一个有效套餐（不会叠加）。换档会替换当前套餐，Shopify 可能按比例结算。",
      "lowerPlanHint": "更低档不是再买一份。若要替换 {{plan}}，请在 Shopify 改计划（可能按比例结算）。",
