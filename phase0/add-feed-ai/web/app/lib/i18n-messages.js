...
export const messages = {
  ...
  "billing": {
    ...
    "plans": {
      ...
      "pageIntro": "Plans and charges are managed by Shopify App Pricing. Tap a paid plan to open Shopify’s plan page.",
  ...
  "billing": {
    ...
    "plans": {
      ...
      "back": "返回",
      "pageTitle": "选择套餐",
      "pageIntro": "套餐与收费由 Shopify App Pricing 托管。点付费套餐将打开 Shopify 官方套餐页。",
